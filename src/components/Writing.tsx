...
interface focusContext {
  focusScenario: boolean;
  setfocusScenario: Dispatch<SetStateAction<boolean>>;
}
export const FocusContext = createContext<focusContext>({ focusScenario: false, setfocusScenario: e => !e} );

const Writing = () => {
 
 const [focusScenario, setfocusScenario] = useState<boolean>(false);

 const sampleContext:focusContext = {
   focusScenario,
   setfocusScenario
 }
          ...
          <div className="flex flex-col w-4/6 ">
            ...
            <div className="flex flex-row space-x-6">
              ...
              <div className="w-full">
                {/* getScenario */}
                <textarea
                  className={`resize-none bg-transparent w-11/12 text-xl placeholder:text-neutral-600/${focusScenario?100:60}  `}
                  disabled
            ...
            <div className="flex flex-row justify-end gap-2">
              ...
              <div className="mt-1">
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path d="M0 0H18V4.28571H0V0ZM0 8.57143H18V12.8571H0V8.57143ZM12 17.1429H0V21.4286H12V17.1429Z" fill="#2D2E30"/>
                  <path d="M20 9.57144H23V15.5714H29V18.5714H23V24.5714H20V18.5714H14V15.5714H20V9.57144Z" fill="#2D2E30"/>
                </svg>
              </div>
            </div>
          </div>
